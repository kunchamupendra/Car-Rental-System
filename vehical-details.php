  ...
  <div class="container">
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p style="color: #333"><span style="font-size:25px"><i class="fa fa-inr" aria-hidden="true"></i>
         </span><?php echo htmlentities($result->PricePerDay);?> </p>Per Day
    ...
    <div class="row">
      <div class="col-md-9">
        ...
        <div class="listing_more_info" style="width:600px;">
          <div class="listing_detail_wrap"> 
            <!-- Nav tabs -->
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab" style="margin-left:100px">Vehicle Overview </a></li>
...
<?php }} ?>
      ...
      <aside class="col-md-3" style="margin-left: -200px;width:480px;">
        ...
        <div class="share_vehicle" style="text-align: center;justify-content: center;">
          <p><a href="#"><i class="fa fa-facebook-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-twitter-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i></a> <a href="#"><i class="fa fa-google-plus-square" aria-hidden="true"></i></a> </p>
        </div>
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="fa fa-envelope" aria-hidden="true" style="color: #04dbc0;"></i>Book Now</h5>
          </div>
          <form method="post">
            ...
            <div class="form-group">
              <input type="text" class="form-control" name="message" placeholder="Mobile Number" required>
            </div>
            </div>
...
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login For Book</a>
    ...
    <!--Similar-Cars-->
    <div class="similar_cars" style="margin-left:200px">
      <h3>Similar Cars</h3>
      <div class="row">
<?php 
$bid=$_SESSION['brndid'];
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price"><i class="fa fa-inr" aria-hidden="true"></i> <?php echo htmlentities($result->PricePerDay);?></p>
