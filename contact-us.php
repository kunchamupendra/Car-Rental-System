...
<style type="text/css">
  .image{
    background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url("assets/images/carlisting.jpg");
    min-height: 75vh;
...
<!--Contact-us-->
<section class="contact_us section-padding" style="margin-top:-50px">
  <div class="container">
    <div  class="row">
      <div class="col-md-6">
        <h3>Get in touch</h3>
...
{ ?>
          <ul>
            <li>
              ...
              <div class="contact_info_m">Panvel, Mumbai Maharashtra</div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-envelope" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="">carrental@gmail.com</a></div>
            </li>
            <li>
              <div class="icon_wrap"><i class="fa fa-phone" aria-hidden="true"></i></div>
              <div class="contact_info_m"><a href="mailto:contact@exampleurl.com">+91 7013189730</a></div>
            </li>
          </ul>
        <?php }} ?>
        </div>
