...
<style type="text/css">
.image{
   background-image: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(assets/images/slide1.jpg);
    min-height:75vh;
...
@keyframes slider{
    0%{
       background-image:linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)),url(assets/images/slide2.jpg);  
      background-size: 100% 100%; 
    }
    20%{
      background-image:linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)),url(assets/images/slide3.jpg); 
       background-size: 100% 100%; 
     }
    40%{
        background-image:linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)),url(assets/images/slide4.jpg); 
         background-size: 100% 100%; 
       }
...
<div class="image">
  <div class="sidebar_widget" style="width:500px;margin-top: 120px; background: rgba(255,255,255,0.04);
...
foreach($results as $result)
{  ?>
        <div class="product-listing-m gray-bg" style="border: 1px solid #cccccc;margin-left: 70px;">
